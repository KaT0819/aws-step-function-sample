...
```bash
sam-step-function-sample$ sam build
```
...
```bash
sam-step-function-sample$ sam logs -n StockCheckerFunction --stack-name sam-step-function-sample --tail
```
...
```bash
sam-step-function-sample$ go test -v ./functions/...
```
...
```bash
sam delete --stack-name sam-step-function-sample
```
